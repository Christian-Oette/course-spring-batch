...
@SpringBootTest(classes = {SkipItemsWithNullReturnTest.TestConfig.class, CourseUtilBatchTestConfig.class})
class SkipItemsWithNullReturnTest {
    ...
    static class TestConfig {
        ...
        public JsonFileItemWriter<SkipTestData> writer() {
            Resource outputResource = new FileSystemResource("output/skipOutput1.json");
