...
@SpringBootTest(classes = {StepScopeAndJobScopeTest.TestConfig.class, CourseUtilBatchTestConfig.class})
class StepScopeAndJobScopeTest {
    ...
    void runJob() throws Exception {
        ...
        }
        {
            JobParameters jobParameters = new JobParametersBuilder()
                    ...
                    .addParameter("chunkSize", new JobParameter(2L))
                    .toJobParameters();
